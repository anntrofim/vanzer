	...
	$("#fullpage").fullpage({
		...
		onLeave: function(index, nextIndex, direction) {
			...
			if(nextIndex == 4) {
				...
				isAnimatedPortfolio.eq(2).addClass('animated fadeInRight').css({'animation-delay': '1.7s', 'animation-duration': '1s'}); // cat-1
				isAnimatedPortfolio.eq(3).addClass('animated fadeInRight').css({'animation-delay': '1.9s', 'animation-duration': '1s'}); // cat-2
				isAnimatedPortfolio.eq(4).addClass('animated fadeInRight').css({'animation-delay': '2.1s', 'animation-duration': '1s'}); // cat-3
			}

			if(nextIndex == 5) {
				isAnimatedBlog.eq(0).addClass('animated fadeInDown').css({'animation-delay': '.5s', 'animation-duration': '1.5s'}); // title
				isAnimatedBlog.eq(1).addClass('animated fadeInLeft').css({'animation-delay': '1.2s', 'animation-duration': '1s'}); // pic-title
...
$('.autoplay-i, .autoplay-w, .autoplay-p').slick({
	slidesToShow: 3,
	slidesToScroll: 1,
	autoplay: true,
	autoplaySpeed: 5000,
